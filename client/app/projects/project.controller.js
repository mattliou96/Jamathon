(function () {
    ...
    ProjectCtrl.$inject = ['ProjectSvc', 'Upload', '$scope', '$log', 'AuthFactory'];

    function ProjectCtrl(ProjectSvc, Upload, $scope, $log, AuthFactory) {
        ...
        sequencer.init = function () {
            utils.net.loadSequence('app/projects/assets/empty-project.json', function (response) {
